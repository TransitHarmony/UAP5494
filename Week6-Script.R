...
CleanBusStopData22$Seating <- factor(CleanBusStopData22$Seating)
CleanBusStopData22$Shelter <- factor(CleanBusStopData22$Shelter)
CleanBusStopData22$Nearside <- factor(CleanBusStopData22$Nearside)
CleanBusStopData22$Farside <- factor(CleanBusStopData22$Farside)
CleanBusStopData22$SharedStop <- factor(CleanBusStopData22$SharedStop)
CleanBusStopData22$City <- factor(CleanBusStopData22$City)
CleanBusStopData22$StateRoad <-factor(CleanBusStopData22$StateRoad)
CleanBusStopData22$LocalRoad <-factor(CleanBusStopData22$LocalRoad)
CleanBusStopData22$Residential <- factor(CleanBusStopData22$Residential)
CleanBusStopData22$Office <-factor(CleanBusStopData22$Office)
CleanBusStopData22$School <-factor(CleanBusStopData22$School)
CleanBusStopData22$Retail <-factor(CleanBusStopData22$Retail)
...
SeatingGLM <- glm(Seating ~ LogTrips +
                    LogPop +
                    PctNonWhite +
                    LogLowIncome +
                    LogJobs +
