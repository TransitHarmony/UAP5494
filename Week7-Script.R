...
DC_Data$AvgVehHH <- (DC_Data$Households_1veh_RentE + 
                     DC_Data$Households_2veh_RentE +
                     DC_Data$Households_3veh_RentE +
                     DC_Data$Households_4veh_RentE +
                     DC_Data$Households_5veh_RentE +
                     DC_Data$Households_1veh_OwnE +
                     DC_Data$Households_2veh_OwnE +
                     DC_Data$Households_3veh_OwnE +
                     DC_Data$Households_4veh_OwnE +
                     DC_Data$Households_5veh_OwnE)/DC_Data$Households_AllE*100 
...
### results suggest over dispersion (p<0.04) and thus negative binomial is more appropriate
